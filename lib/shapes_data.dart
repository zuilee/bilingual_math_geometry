    ...
    'section': [
      {
        ...
        'page': const GenericIntroductionPage(shapeName: 'Lines'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Lines'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Lines'),
      },
    ],
  },
  {
    ...
    'section': [
      {
        ...
        'icon': Icons.book,
        'color': const Color(0xFF5CB85C),
        'page': const GenericIntroductionPage(shapeName: 'Planes'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Planes'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Planes'),
      },
    ],
  },
  {
    ...
    'section': [
      {
        ...
        'icon': Icons.book,
        'color': const Color(0xFF5CB85C),
        'page': const GenericIntroductionPage(shapeName: 'Angles'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Angles'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Angles'),
      },
    ],
  },
  {
    ...
    'section': [
      {
        ...
        'icon': Icons.book,
        'color': const Color(0xFF5CB85C),
        'page': const GenericIntroductionPage(shapeName: 'Triangle'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Triangle'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Triangle'),
      },
    ],
  },
  {
    ...
    'section': [
      {
        ...
        'icon': Icons.book,
        'color': const Color(0xFF5CB85C),
        'page': const GenericIntroductionPage(shapeName: 'Quadrilateral'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Quadrilateral'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Quadrilateral'),
      },
    ],
  },
  {
    ...
    'section': [
      {
        ...
        'icon': Icons.book,
        'color': const Color(0xFF5CB85C),
        'page': const GenericIntroductionPage(shapeName: 'Circle'),
      },
      {
        'title': 'Practice',
        'icon': Icons.lightbulb_outline,
        'color': const Color(0xFFF76E11),
        'page': const GenericPracticePage(shapeName: 'Circle'),
      },
      {
        'title': 'Quiz',
        'icon': Icons.question_answer_outlined,
        'color': const Color(0xFF8B5CF6),
        'page': const GenericQuizPage(shapeName: 'Circle'),
      },
    ],
  },
];
